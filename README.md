...
In this sample code, you will use the created demo project to call APIs of Voice Kit. Through the demo project, you will:
1.	Access basic voice ability: transfer voice data into text output.	
2.	Access scenario voice ability: identify directives with input voice.
3.  Access natural language ability: extract fundamental information entity from text input.

For more information, please refer to [Service Introduction](https://developer.honor.com/cn/docs/11018/guides/introduction).
...
If you encounter any issues when using the sample code, submit your [issues](https://github.com/HONORDevelopers/voicekit-demo/issues) or submit a [pull request](https://github.com/HONORDevelopers/voicekit-demo/pulls).
